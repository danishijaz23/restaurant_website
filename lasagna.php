...
<body>
  <?php
  if (isset($_POST['bundle']) && !is_array($_POST['bundle'])) {
    $bundle = isset($_POST['bundle']) ? $_POST['bundle'] : '<em>empty</em>';
  } else {
    $bundle = '<em>empty</em>';
  }
  ?>
  ...
  <?php if (!isset($_POST['bundle']) && !isset($_POST['lasagnas'])) { ?>
    <em>Sorry, we did not receive your information. <a href="lasagna_form.html">Try again.</a></em>
  <?php } else { ?>
    <ul>
      <li><strong>Lasagna Bundle:</strong> <?php print $bundle; ?></li>
      <li><strong>Number of lasagnas:</strong> <?php print isset($_POST['lasagnas']) && $_POST['lasagnas'] ? $_POST['lasagnas'] : '<em>empty</em>'; ?></li>
    </ul>
