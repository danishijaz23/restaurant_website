...
<body>
  ...
  <?php if (!isset($_POST['size']) && !isset($_POST['Haleems'])) { ?>
    <em>Sorry, we did not receive your information. <a href="haleem_form.html">Try again.</a></em>
  <?php } else { ?>
    <ul>
      <li><strong>Size:</strong> <?php print $size; ?></li>
      <li><strong>Number of haleems:</strong> <?php print isset($_POST['Haleems']) && $_POST['Haleems'] ? $_POST['Haleems'] : '<em>empty</em>'; ?></li>
    </ul>
