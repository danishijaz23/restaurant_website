...
<body>
  ...
  $quantity = isset($_POST['gulab_jamun']) ? intval($_POST['gulab_jamun']) : 0;
  ?>
  ...
  <h2>Your Gulab Jamun Cheesecake</h2>

  <?php if (!isset($_POST['size']) && !isset($_POST['gulab_jamun'])) { ?>
    <em>Sorry, we did not receive your information. <a href="gulab_jamun_form.html">Try again.</a></em>
  <?php } else { ?>
    <ul>
      <li><strong>Size:</strong> <?php print $size; ?></li>
      <li><strong>Number of Gulab Jamun Cheesecakes:</strong> <?php print ($_POST['gulab_jamun']); ?></li>
    </ul>
