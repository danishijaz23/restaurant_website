...
<body>
  ...
  $quantity = isset($_POST['biscoff_cheesecake']) ? intval($_POST['biscoff_cheesecake']) : 0;
  ?>
  ...
  <h2>Your Biscoff Cheesecake</h2>

  <?php if (!isset($_POST['size']) && !isset($_POST['biscoff_cheesecake'])) { ?>
    <em>Sorry, we did not receive your information. <a href="biscoff_cheesecake_form.html">Try again.</a></em>
  <?php } else { ?>
    <ul>
      <li><strong>Size:</strong> <?php print $size; ?></li>
      <li><strong>Number of Biscoff Cheesecakes:</strong> <?php print ($_POST['biscoff_cheesecake']); ?></li>
    </ul>
