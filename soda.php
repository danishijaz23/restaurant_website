...
<body>
  <?php
  if (isset($_POST['soda']) && !is_array($_POST['soda'])) {
    $sodaType = isset($_POST['soda']) ? $_POST['soda'] : '<em>empty</em>';
  } else {
    $sodaType = isset($_POST['soda']) ? implode(', ', $_POST['soda']) : '<em>empty</em>';
  }
  ...
  <?php if (!isset($_POST['soda']) && !isset($_POST['size'])) { ?>
    <em>Sorry, we did not receive your information. <a href="soda_form.html">Try again.</a></em>
  <?php } else { ?>
    <ul>
      <li><strong>Soda Type:</strong> <?php print $sodaType; ?></li>
      <li><strong>Size:</strong> <?php print $size; ?> oz.</li>
      <li><strong>Number of Soda Bottles/Cans:</strong> <?php print isset($_POST['quantity']) ? $_POST['quantity'] : '<em>empty</em>'; ?></li>
    </ul>
