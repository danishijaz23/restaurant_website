...
<body>
  <?php
  if (isset($_POST['pancake']) && !is_array($_POST['pancake'])) {
    $pancakeType = isset($_POST['pancake']) ? $_POST['pancake'] : '<em>empty</em>';
  } else {
    $pancakeType = isset($_POST['pancake']) ? implode(', ', $_POST['pancake']) : '<em>empty</em>';
  }
  ?>
  ...
  <?php if (!isset($_POST['pancakes']) && !isset($_POST['pancakes'])) { ?>
    <em>Sorry, we did not receive your information. <a href="pancake_form.html">Try again.</a></em>
  <?php } else { ?>
    <ul>
      <li><strong>Pancake Flavor:</strong> <?php print $pancakeType; ?></li>
	  <li><strong>Number of Pancakes:</strong> <?php print isset($_POST['pancakes']) ? $_POST['pancakes'] : '<em>empty</em>'; ?></li>
    </ul>
