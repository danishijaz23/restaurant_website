...
<body>
  ...
  <?php if (!isset($_POST['size']) && !isset($_POST['Niharis'])) { ?>
    <em>Sorry, we did not receive your information. <a href="nihari_form.html">Try again.</a></em>
  <?php } else { ?>
    <ul>
      <li><strong>Size:</strong> <?php print $size; ?></li>
      <li><strong>Number of niharis:</strong> <?php print isset($_POST['Niharis']) && $_POST['Niharis'] ? $_POST['Niharis'] : '<em>empty</em>'; ?></li>
    </ul>
