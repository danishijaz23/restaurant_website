...
<body>
  <?php
  if (isset($_POST['waffle']) && !is_array($_POST['waffle'])) {
    $waffleType = isset($_POST['waffle']) ? $_POST['waffle'] : '<em>empty</em>';
  } else {
    $waffleType = isset($_POST['waffle']) ? implode(', ', $_POST['waffle']) : '<em>empty</em>';
  }
  ?>
  ...
  <?php if (!isset($_POST['waffle']) && !isset($_POST['waffle'])) { ?>
    <em>Sorry, we did not receive your information. <a href="waffle_form.html">Try again.</a></em>
  <?php } else { ?>
    <ul>
      <li><strong>Waffle Flavor:</strong> <?php print $waffleType; ?></li>
	  <li><strong>Number of Waffles:</strong> <?php print isset($_POST['waffles']) ? $_POST['waffles'] : '<em>empty</em>'; ?></li>
    </ul>
