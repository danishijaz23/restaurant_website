...
<body>
  ...
  if (isset($_POST['condiments']) && !is_array($_POST['condiments'])) {
    $condiments = isset($_POST['condiments']) ? $_POST['condiments'] : '<em>empty</em>';
  } else {
  ...
  <?php if (!isset($_POST['condiments']) && !isset($_POST['hotdogs'])) { ?>
    <em>Sorry, we did not receive your information. <a href="hotdog_form.html">Try again.</a></em>
  <?php } else { ?>
    <ul>
      <li><strong>Condiments:</strong> <?php print $condiments; ?></li>
      <li><strong>Number of hotdogs:</strong> <?php print isset($_POST['hotdogs']) && $_POST['hotdogs'] ? $_POST['hotdogs'] : '<em>empty</em>'; ?></li>
    </ul>
