...
<body>
  ...
  if (isset($_POST['condiments']) && !is_array($_POST['condiments'])) {
    $condiments_problem = TRUE;
    $condiments = is_string($_POST['condiments']) ? $_POST['condiments'] : '<em>empty</em>';
  } else {
    $condiments_problem = FALSE;
    $condiments = isset($_POST['condiments']) ? implode(', ', $_POST['condiments']) : '<em>empty</em>';
  }
  ?>
  <h1>THANK YOU</h1>
  ...
  <ul>
    <li><strong>Name:</strong> <?php echo $_POST['name'] ? $_POST['name'] : '<em>empty</em>'; ?></li>
    <li><strong>Address:</strong> <?php echo $_POST['address'] ? $_POST['address'] : '<em>empty</em>'; ?></li>
    <li><strong>Telephone number:</strong> <?php echo $_POST['telephone'] ? $_POST['telephone'] : '<em>empty</em>'; ?></li>
    <li><strong>Email Address:</strong> <?php echo $_POST['email'] ? $_POST['email'] : '<em>empty</em>'; ?></li>
    <li><strong>Delivery instructions:</strong> <?php echo $_POST['instructions'] ? $_POST['instructions'] : '<em>empty</em>'; ?></li>
  </ul>

  <h2>Your Cheeseburger</h2>

  <?php if (!isset($_POST['combo']) && !isset($_POST['toppings']) && !isset($_POST['cheeseburgers'])) { ?>
    <em>Sorry, we did not receive your information. <a href="cheeseburger-form.html">Try again.</a></em>
  <?php } else { ?>
    <ul>
      <li><strong>Combo Size:</strong> <?php echo isset($_POST['combo']) && $_POST['combo'] ? $_POST['combo'] : '<em>empty</em>'; ?></li>
      ...
      <li><strong>Condiments:</strong> <?php
        echo $condiments;
        if ($condiments_problem) { ?>
          <span style="color:red">*</span>
        <?php } ?>
      </li>
      <li><strong>Number of cheeseburgers:</strong> <?php echo isset($_POST['cheeseburgers']) && $_POST['cheeseburgers'] ? $_POST['cheeseburgers'] : '<em>empty</em>'; ?></li>
    </ul>
  ...
  <?php }
  if ($toppings_problem || $condiments_problem) { ?>
    <hr>
    <p>&nbsp;</p>
  <?php } ?>
  <br>
