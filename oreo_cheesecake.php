...
<body>
  ...
  $quantity = isset($_POST['oreo_cheesecake']) ? intval($_POST['oreo_cheesecake']) : 0;
  ?>
  ...
  <h2>Your Oreo Cheesecake</h2>

  <?php if (!isset($_POST['size']) && !isset($_POST['oreo_cheesecake'])) { ?>
    <em>Sorry, we did not receive your information. <a href="oreo_cheesecake_form.html">Try again.</a></em>
  <?php } else { ?>
    <ul>
      <li><strong>Size:</strong> <?php print $size; ?></li>
      <li><strong>Number of Oreo Cheesecakes:</strong> <?php print ($_POST['oreo_cheesecake']); ?></li>
    </ul>
