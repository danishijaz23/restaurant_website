...
<body>
  ...
  $quantity = isset($_POST['red_velvet']) ? intval($_POST['red_velvet']) : 0;
  ?>
  ...
  <h2>Your Red Velvet Cake</h2>

  <?php if (!isset($_POST['size']) && !isset($_POST['red_velvet'])) { ?>
    <em>Sorry, we did not receive your information. <a href="red_velvet_form.html">Try again.</a></em>
  <?php } else { ?>
    <ul>
      <li><strong>Size:</strong> <?php print $size; ?></li>
      <li><strong>Number of Red Velvet Cakes:</strong> <?php print ($_POST['red_velvet']); ?></li>
    </ul>
