...
<body>
  <?php
  if (isset($_POST['ice_cream']) && !is_array($_POST['ice_cream'])) {
    $ice_creamType = isset($_POST['ice_cream']) ? $_POST['ice_cream'] : '<em>empty</em>';
  } else {
    $ice_creamType = isset($_POST['ice_cream']) ? implode(', ', $_POST['ice_cream']) : '<em>empty</em>';
  }
  ...
  <?php if (!isset($_POST['ice_cream']) && !isset($_POST['size']) && !isset($_POST['quantity'])) { ?>
    <em>Sorry, we did not receive your information. <a href="ice_cream_form.html">Try again.</a></em>
  <?php } else { ?>
    <ul>
      <li><strong>Ice Cream Flavor:</strong> <?php print $ice_creamType; ?></li>
      <li><strong>Size:</strong> <?php print $size; ?></li>
      <li><strong>Quantity:</strong> <?php print $quantity; ?></li>
    </ul>
