...
<li><strong>Delivery instructions:</strong> <?php print $_POST['instructions'] ? $_POST['instructions'] : '<em>empty</em>'; ?></li>
</ul>

<h2>Your Pizza</h2>

<?php if (!isset($_POST['crust']) && !isset($_POST['toppings']) && !isset($_POST['pizzas'])) { ?>
<em>Sorry, we did not receive your information. <a href="pizza_form.html">Try again.</a></em>
<?php } 
  else { ?>
    <ul>
	...
	<?php
      if (isset($_POST['toppings']) && is_array($_POST['toppings']) && count($_POST['toppings']) > 0) {
    ...
    <li><strong>Number of pizzas:</strong> <?php print isset($_POST['pizzas']) && $_POST['pizzas'] ? $_POST['pizzas'] : '<em>empty</em>'; ?></li>
    </ul>
