...
<body>
  ...
  <?php if (!isset($_POST['size']) && !isset($_POST['Biryanis'])) { ?>
    <em>Sorry, we did not receive your information. <a href="biryani_form.html">Try again.</a></em>
  <?php } else { ?>
    <ul>
      <li><strong>Size:</strong> <?php print $size; ?></li>
      <li><strong>Number of biryanis:</strong> <?php print isset($_POST['Biryanis']) && $_POST['Biryanis'] ? $_POST['Biryanis'] : '<em>empty</em>'; ?></li>
    </ul>
