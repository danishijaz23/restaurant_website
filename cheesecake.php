...
<body>
  ...
  $quantity = isset($_POST['cheesecake']) ? intval($_POST['cheesecake']) : 0;
  ?>
  ...
  <h2>Your Cheesecake</h2>

  <?php if (!isset($_POST['size']) && !isset($_POST['cheesecake'])) { ?>
    <em>Sorry, we did not receive your information. <a href="cheesecake_form.html">Try again.</a></em>
  <?php } else { ?>
    <ul>
      <li><strong>Size:</strong> <?php print $size; ?></li>
      <li><strong>Number of Cheesecakes:</strong> <?php print ($_POST['cheesecake']); ?></li>
    </ul>
